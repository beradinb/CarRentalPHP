...
<form id="form" name="Registration" action="Registration.php" onsubmit="return checkempty();" method="POST">
...
<?php
  ...
  $query = $db->prepare("INSERT INTO reg_users ( username, password, first_name, surname, email, isAdmin ) VALUES ( :username, :password, :first_name, :surname, :email, FALSE )");
